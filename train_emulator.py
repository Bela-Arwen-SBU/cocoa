...
def train_emulator(train_yaml, probe,
    ...
    for e in range(n_epochs):
        ...
        with torch.no_grad():
            ...
            test_frac_gt_0p2.append(n_gt_0p2 / n_total)
            test_frac_gt_1.append(n_gt_1 / n_total)
    ...
    if ( save_testing_metrics ):
        np.savetxt("testing_metrics.txt", np.array([test_mean_chi2,test_median_chi2,test_frac_gt_0p2,test_frac_gt_1],dtype=np.float64))
